...
import { submitRosterForReview } from "@/modules/rosters/services/lifecycle"
...
export async function submitRosterForReviewAction(
  ...
  try {
    const roster = await submitRosterForReview(parsed.data.id)
    ...
    return {
      ok: false,
      error: "Unable to submit the roster for review. Please try again.",
    }
  }
}
